...
// Models are moved to lib/src/models/models.dart
...
class _AttendanceHomePageState extends State<AttendanceHomePage> {
  ...
  void _loadDefaultSubjects() {
    subjects = [
      Subject(name: 'L_DAA', code: 'GK', teacher: 'GK'),
      Subject(name: 'L_DBMS', code: 'SS', teacher: 'SS'),
      Subject(name: 'L_WT', code: 'PG', teacher: 'PG'),
      Subject(name: 'L_COI', code: 'MP', teacher: 'MP'),
      Subject(name: 'L_DA/OOSD', code: 'AK/RS', teacher: 'AK/RS'),
      Subject(name: 'L_MLT', code: 'RS', teacher: 'RS'),
      Subject(name: 'Mini Project B1', code: '311/DAA B2 312', teacher: 'DSM/GK'),
      Subject(name: 'Mini Project B2', code: '110/DAA B1 108', teacher: 'DSM/GK'),
      Subject(
          name: 'DBMS LAB B1 110/ WT LAB B2 108',
          code: 'SS/PG',
          teacher: 'SS/PG'),
      Subject(
          name: 'DBMS LAB B2 108/ WT LAB B1 110',
          code: 'SS/PG',
          teacher: 'SS/PG'),
      Subject(name: 'Learnovate', code: '', teacher: ''),
      Subject(name: 'NPTEL/LIB', code: '', teacher: ''),
    ];
    _saveSubjects();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: editableSubjects.isEmpty
          ...
          : ListView.builder(
              padding: const EdgeInsets.all(16),
              itemCount: editableSubjects.length,
              itemBuilder: (context, index) {
...
// Add/Edit Subject Dialog moved to lib/src/widgets/dialogs.dart
...
// Add/Edit Class Dialog moved to lib/src/widgets/dialogs.dart
